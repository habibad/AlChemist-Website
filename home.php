...
<body bgcolor="lightyellow">
   ...
   <section class="hero">
      ...
      <div class="swiper hero-slider">
         <div class="swiper-wrapper">
            ...
            <div class="swiper-slide slide">    
               <div class="image">
               <img src="images/home-img-chem3.png" alt="">
               </div>
            </div>
         </div>
   ...
   <section class="category">
      ...
      <div class="box-container">
         ...
         <a href="category.php?category=Solid" class="box">
            <img src="images/cat-chem1.png" alt="">
            <h3>Solid</h3>
         </a>

         <a href="category.php?category=Liquid" class="box">
            <img src="images/cat-chem2.png" alt="">
            <h3>Liquid</h3>
         </a>

         <a href="category.php?category=Gaseous" class="box">
